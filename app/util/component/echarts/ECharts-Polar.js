 ...
 * ECharts--雷达图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Polar', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Polar'],
    ...
    constructor: function () {
        var _config = {
            ...
            optionJs: "col=[\"#f54d4d\" , \"#f87544\", \"#ffae00\" , \"#dcff00\" , \"#25d053\",\"#01fff5\" , \"#007cff\", \"#4245ff\" , \"#c32eff\" , \"#ff62e8\"];",
            ...
            "        interval: 1," +
            "        type: 'category'," +
            "        data: ['太平驿公司', '宝兴河公司', '嘉陵江公司', '康定公司', '培江公司']," +
            "        z: 10," +
            "        axisLine: {" +
            "            show: true," +
            "            lineStyle: {" +
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Polar' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Polar'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

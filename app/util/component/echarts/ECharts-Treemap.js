 ...
 * ECharts--树块图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Treemap', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Treemap'],
    ...
    constructor: function () {
        var _config = {
            ...
            /** Echarts配置项 */
            option: "var uploadedDataURL = \"resources/plugin/echarts/data/ec-option-doc-statistics-201604.json\";" +
            // "" +
            // "myChart.showLoading();" +
            // "" +
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Treemap' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Treemap'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

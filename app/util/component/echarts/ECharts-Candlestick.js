 ...
 * ECharts--烛台图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Candlestick', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Candlestick'],
    ...
    constructor: function () {
        var _config = {
            ...
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-Candlestick',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-Candlestick',
            /** 元件创建时的初始化样式 */
            iconCls: '',
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Candlestick' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Candlestick'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

 ...
 * ECharts--增强函数图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-GL-Graph', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-GL-Graph'],
    ...
    constructor: function () {
        var _config = {
            ...
            lock: false,
            /** 元件类型 */
            type: 'ECharts-GL-Graph',
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-GL-Graph',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-GL-Graph',
            /** 元件创建时的初始化样式 */
            iconCls: '',
            ...
            optionJs:  "function createNodes(widthCount, heightCount) {" +
            "    var nodes = [];" +
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-GL-Graph' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-GL-Graph'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

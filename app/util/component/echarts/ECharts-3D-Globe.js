 ...
 * ECharts--三维球
 */
Ext.define('Cosmo.util.component.echarts.ECharts-3D-Globe', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-3D-Globe'],
    ...
    constructor: function () {
        var _config = {
            ...
            lock: false,
            /** 元件类型 */
            type: 'ECharts-3D-Globe',
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-3D-Globe',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-3D-Globe',
            /** 元件创建时的初始化样式 */
            iconCls: '',
            ...
            "    backgroundColor: '#000'," +
            "    globe: {" +
            "        baseTexture: \"resources/plugin/echarts/data/gl/world.topo.bathy.200401.jpg\"," +
            "        heightTexture: \"resources/plugin/echarts/data/gl/world.topo.bathy.200401.jpg\"," +
            "        displacementScale: 0.04," +
            "        shading: 'realistic'," +
            "        environment: 'resources/plugin/echarts/data/gl/starfield.jpg'," +
            "        realisticMaterial: {" +
            "            roughness: 0.9" +
            "        }," +
            "        postEffect: {" +
            ...
            "            }," +
            "            ambientCubemap: {" +
            "                texture: 'resources/plugin/echarts/data/gl/pisa.hdr'," +
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-3D-Globe' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-3D-Globe'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

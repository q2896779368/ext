 ...
 * ECharts--水球图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Liquidfill', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Liquidfill'],
    ...
    constructor: function () {
        var _config = {
            ...
            lock: false,
            /** 元件类型 */
            type: 'ECharts-Liquidfill',
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-Liquidfill',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-Liquidfill',
            /** 元件创建时的初始化样式 */
            iconCls: '',
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Liquidfill' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Liquidfill'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

 ...
 * ECharts--对比图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Parallel', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Parallel'],
    ...
    constructor: function () {
        var _config = {
            ...
            lock: false,
            /** 元件类型 */
            type: 'ECharts-Parallel',
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-Parallel',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-Parallel',
            /** 元件创建时的初始化样式 */
            iconCls: '',
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Parallel' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Parallel'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

 ...
 * ECharts--仪表盘
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Gauge', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Gauge'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Gauge' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Gauge'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

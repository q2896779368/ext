 ...
 * ECharts--象形柱图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-PictorialBar', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-PictorialBar'],
    ...
    constructor: function () {
        var _config = {
            ...
            /** 别名（Cosui元件名称） */
            alias: 'ECharts-PictorialBar',
            /** Cosui标签 */
            tag: 'div',
            /** Cosui样式表 */
            cls: 'ECharts-PictorialBar',
            /** 元件创建时的初始化样式 */
            iconCls: '',
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-PictorialBar' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-PictorialBar'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

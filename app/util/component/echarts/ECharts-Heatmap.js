 ...
 * ECharts--热力图
 */
Ext.define('Cosmo.util.component.echarts.ECharts-Heatmap', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.ECharts-Heatmap'],
    ...
    constructor: function () {
        var _config = {
            ...
            optionJs: "$.get('resources/plugin/echarts/data/hangzhou-tracks.json', function (data) {" +
            "" +
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Heatmap' id='" + this.id + this.type + "' data-options='" + dataOptions + "'></div>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;height:100%' " + newCombo + " class='ECharts-Heatmap'  id='" + activeId + type + "' data-options='" + dataOptions + "'></div>";

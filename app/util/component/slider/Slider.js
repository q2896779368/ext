 ...
 * 元件--滑动条
 */
Ext.define('Cosmo.util.component.slider.Slider', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Slider'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<input showTip='true' id='"+this.id+this.type+"' style='width:100%;' "+ newCombo + " class='cosui-slider "+ cls+"' data-options='" + dataOptions + "'>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<input showTip='true'  id='"+activeId+type+"' style='width:100%;' "+ newCombo + " class='cosui-slider "+ cls+"' data-options='" + dataOptions + "'>";

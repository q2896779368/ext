 ...
 * 元件--垂直线
 */
Ext.define('Cosmo.util.component.vertical.Vertical', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Vertical'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html ="<div class='vertical "+ cls+"' id='"+this.id+this.type+"' style='width:100%;height:100%; border:1px solid #ddd;border-right: 0px'></div>"  ;
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html ="<div class='vertical "+ cls+"'  id='"+activeId+type+"' style='width:100%;height:100%;border:1px solid #ddd; border:0px'></div>";

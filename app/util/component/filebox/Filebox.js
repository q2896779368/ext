 ...
 * 元件--文件上传
 */
Ext.define('Cosmo.util.component.filebox.Filebox', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Filebox'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<input label='文件:' prompt='请选择文件...' labelPosition='left' style='width:100%;' "+ newCombo + " class='cosui-filebox "+ cls+"' id='"+this.id+this.type+"' data-options='" + dataOptions + "'>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<input label='文件:' prompt='请选择文件...' labelPosition='left' style='width:100%;' "+ newCombo + " class='cosui-filebox "+ cls+"' id='"+activeId+type+"' data-options='" + dataOptions + "'>";

 ...
 * 元件--复选框
 */
Ext.define('Cosmo.util.component.checkbox.Checkbox', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Checkbox'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<div style='width:100%;' class='cosui-checkbox "+ cls+"' id='" + this.id + this.type + "' " + newCombo + " data-options='" + dataOptions + "'>" +
            "<input type='checkbox' name='' value='' style='vertical-align: middle;'><span>复选框</span>" +
            "</div>";
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = "<div style='width:100%;' class='cosui-checkbox "+ cls+"' id='" + activeId + type + "' " + newCombo + " data-options='" + dataOptions + "'>" +
                "<input style='vertical-align: middle;' type='checkbox' name='" + group + "' value='" + value + "'><span>" + label + "</span>" +
                "</div>";

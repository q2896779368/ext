 ...
 * 元件--按钮
 */
Ext.define('Cosmo.util.component.button.Button', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Button'],
    ...
    constructor: function () {
        var _config = {
            ...
            tag: 'a',
            /** Cosui样式表 */
            cls: 'cosui-linkbutton',
            /** 元件创建时的初始化样式 */
            iconCls: 'icon_mxr_control_button',
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html = "<a style='width:100%;height:100%;display:inline-block;' "+ newCombo + " class='cosui-linkbutton "+ cls+"' id='"+this.id+this.type+"' data-options='" + dataOptions + "'></a>";
        var proxy = {
            tag: 'div',
            type: this.type,
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html = '<a style="width:100%;height:100%;display:inline-block;" id="'+activeId+type+'" class="cosui-linkbutton '+ cls+'" ' + newCombo + ' data-options="' + dataOptions + '"></a>'

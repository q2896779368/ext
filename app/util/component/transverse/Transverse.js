 ...
 * 元件--水平线
 */
Ext.define('Cosmo.util.component.transverse.Transverse', {
    extend: 'Cosmo.util.component.Component',

    alternateClassName: ['Cosmo.Transverse'],
    ...
    createDomProxy: function (left, top, dataOptions, combo) {
        ...
        var html ="<div class='transverse "+ cls+"' id='"+this.id+this.type+"' style='width:100%;height:100%; border-top:1px solid #ddd'></div>"  ;
    ...
    statics: {
        ...
        reParse: function () {
            ...
            var html ="<div class='transverse "+ cls+"' id='"+activeId+type+"' style='width:100%;height:100%; border-top:1px solid #ddd'></div>";

var BaseGdm = {
    ...
    decode: function (e) {
        ...
        t = BaseGdm._utf8_decode(t);
        return t
    },
    _unicode_encode: function (input) {
        input = this.unicodeToBytesFwp(input);
        var output = "";
        var chr1, chr2, chr3 = "";
    ...
    _unicode_decode: function (input) {
        var output = "";
        var chr1, chr2, chr3 = "";
        var enc1, enc2, enc3, enc4 = "";
        var i = 0;

...
$(function(){
	...
	var str="<div class='select_time' style='display:none;' >"
				+"	<div class='data'>"
				+"    	<ul id='select_time_hms' style='display: block;'><li class='tit'>时间</li><li><input readonly value='00' class='h'>:</li><li><input readonly value='00' class='m'></li><li><input readonly value='00' style='display:none' class='s'></li></ul>"
				+"        <div class='box'>"

...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
        ...
        this.addEntry('dds son process', function()
        {
            var cell = new mxCell('Son', new mxGeometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;');
            cell.vertex = true;

            var cell1 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'html=1;shape=mxgraph.bpmn.son_process;outlineConnect=0;');
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.geometry.offset = new mxPoint(7, 7);
            cell.insert(cell1);

            var cell2 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'html=1;shape=mxgraph.bpmn.son_process;outlineConnect=0;');
            cell2.vertex = true;
            cell2.geometry.relative = true;
            cell2.geometry.offset = new mxPoint(7, 7);
            cell.insert(cell2);

            return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Son Process');
        }),
        ...
        this.createVertexTemplateEntry('shape=mxgraph.bpmn.son_process;html=1;outlineConnect=0;', 14, 14, '', 'Son Process', null, null, 'dds son process'),
